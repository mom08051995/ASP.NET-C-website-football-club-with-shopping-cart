<%@ Page Language="C#" MasterPageFile="MasterPage2.master" AutoEventWireup="true" CodeFile="SoldProducts.aspx.cs" Inherits="UserInBox_SoldProducts" Title="Your sold products are" %>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    Style="position: static" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="True" CellPadding="0" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting" Width="1024px" Height="1145px">
                    <Columns>
