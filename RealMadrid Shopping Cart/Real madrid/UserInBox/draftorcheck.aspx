...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="text-align: left">
        <table style="width: 508px; position: static; height: 100px" align="center">
            <head runat="server">
            <tr>
                <td style="width: 100px">
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Style="position: static"
                        Text="1)Thank you for buying products from our Shopping cart. Your order has been placed with us and will be dispatched by the couriers services once the payment is received by us on his behalf."
                        Width="498px"></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 100px; height: 21px;">
                    <asp:Label ID="Label2" runat="server" Height="21px" Style="position: static" Text="2)Real Madrid Shopping Cart.."
