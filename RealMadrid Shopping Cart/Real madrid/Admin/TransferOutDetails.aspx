<%@ Page Title="" Language="C#" MasterPageFile="~/Real madrid/Admin/MasterPage3.master" AutoEventWireup="true" CodeFile="TransferOutDetails.aspx.cs" Inherits="Real_madrid_Admin_TransferOutDetails" %>
            ...
            <tr>
                <td style="width: 100px">
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        CellPadding="4" ForeColor="#333333" GridLines="None" PageSize="6" Style="position: static" OnRowDeleting="GridView1_RowDeleting" OnPageIndexChanging="GridView1_PageIndexChanging" Height="740px" Width="1155px">
                        ...
                        <asp:TemplateField HeaderText="TransferFee (in £)">
                        <ItemTemplate>
