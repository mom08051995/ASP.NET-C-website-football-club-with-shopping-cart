...
public partial class UserInBox_ProductGallery : System.Web.UI.Page
{
    ...
    {
        da = new SqlDataAdapter("select prid,pricerange from tbl_pricerange", con);
        ds = new DataSet();
        da.Fill(ds, "tbl_pricerange");
        if (ds.Tables.Count > 0 && ds.Tables["tbl_pricerange"].Rows.Count > 0)
        {
            DropDownList3.DataSource = ds.Tables["tbl_pricerange"];
            DropDownList3.DataTextField = "pricerange";
            DropDownList3.DataValueField = "prid";
    ...
    private void GetProductItemFor(int pid)
    {
        if (DropDownList1.SelectedIndex > 0)
        {
            ...
            if (ds.Tables.Count > 0 && ds.Tables["tbl_itemsofproduct"].Rows.Count > 0)
            {
                DropDownList2.DataSource = ds.Tables["tbl_itemsofproduct"].DefaultView;
    ...
    private void GetAllProducts()
    {
        ...
        //if (ds.Tables.Count > 0 && ds.Tables["tbl_productidetails"].Rows.Count > 0)
        //{
        //    DataList1.DataSource = ds.Tables["tbl_productidetails"].DefaultView;
        //    DataList1.DataBind();
        //}    
    ...
    private void GetProductsOfType(string PType,string ItemFor)
    {
        ...
        if (ds.Tables.Count > 0 && ds.Tables["tbl_productitemdetails"].Rows.Count > 0)
        {
            DataList1.DataSource = ds.Tables["tbl_productitemdetails"].DefaultView;
            DataList1.DataBind();
        }
    }
