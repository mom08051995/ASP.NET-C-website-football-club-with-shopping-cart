...
public partial class Admin_AddItemDetailst : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (FileUpload1.PostedFile.ContentLength > 0 && FileUpload1.HasFile == true)
        {
            ...
            da = new SqlDataAdapter("insert into tbl_productitemdetails(pid,itemid,prid,brandname,imagepath,cost,description,cdate) values(" + Convert.ToInt32(DropDownList1.SelectedValue.ToString()) + "," + Convert.ToInt32(DropDownList2.SelectedValue.ToString()) + "," + Convert.ToInt32(DropDownList3.SelectedValue.ToString()) + ",'" + TextBox1.Text + "','" + imgpath.ToString() + "'," + Convert.ToDecimal(TextBox2.Text) + ",'" + TextBox3.Text + "',getdate())", con);
