...
public partial class CustomerRegistration : System.Web.UI.Page
{
    ...
    {
       TextBox12.Text = Guid.NewGuid().ToString().Substring(0, 6);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            da = new SqlDataAdapter("insert into tbl_login(uname,password,securitycode,status,cdate,email)values('" + TextBox9.Text + "','" + TextBox10.Text + "','" + TextBox11.Text + "','Activate',getdate(),'"+TextBox4.Text+"')", con);
